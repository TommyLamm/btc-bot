...
class GeneticEngine:
    ...
    def _crossover(self, parent1, parent2):
        ...
        child_threshold = random.choice([parent1["threshold"], parent2["threshold"]])
        return {"weights": child_weights, "threshold": child_threshold}
    ...
    def search(self, df: pl.DataFrame) -> Optional[dict]:
